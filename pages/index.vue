      ...
      <div class="flex flex-col items-center pb-10">
        <div class="flex mt-4 md:mt-6">
          ...
          <button v-if="simile[main.id - 1] == -1" @click="simile[main.id - 1] = -100, addToCart(main), compare()"
            ...
            class="inline-flex items-center px-6 py-2 text-sm font-medium text-center text-gray-900 border border-gray rounded-lg hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-blue-300">
            В корзине >
          </button></NuxtLink>
          ...
          <button @click="addToFavourite(main)"
